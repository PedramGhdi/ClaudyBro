...
extension Notification.Name {
    ...
    /// userInfo["previous"]: Bool — direction to search for an OSC 133 prompt.
    static let jumpToPrompt = Notification.Name("com.claudybro.jumpToPrompt")
    /// userInfo: bytes [UInt8], origin pane UUID, tab UUID.
    static let broadcastInput = Notification.Name("com.claudybro.broadcastInput")
}
